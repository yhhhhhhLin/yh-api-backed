...
<mapper namespace="${groupName}.${artifactName}.mapper.PostMapper">

    <resultMap id="BaseResultMap" type="${groupName}.${artifactName}.model.entity.Post">
            ...
            <result property="loveExp" column="loveExp" jdbcType="VARCHAR"/>
    ...
    <sql id="Base_Column_List">
        id,age,gender,
        education,place,job,
        contact,loveExp,content,
        photo,reviewStatus,reviewMessage,
        viewNum,thumbNum,userId,
