...
import ${groupName}.${artifactName}.mapper.PostMapper;
import ${groupName}.${artifactName}.model.entity.Post;
import ${groupName}.${artifactName}.model.enums.PostGenderEnum;
import ${groupName}.${artifactName}.model.enums.PostReviewStatusEnum;
